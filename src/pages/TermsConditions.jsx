      ...
      <section className="bg-dark py-16 text-white">
        <div className="container-main">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-white/80 md:text-base">
            Please review the terms that apply when you access our website, use
            our travel-related services, submit an inquiry, or communicate with
            our support team.
          </p>
        </div>
      </section>
        ...
        <div className="container-main">
          <div className="mx-auto max-w-4xl">
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                We may facilitate interactions between travelers and third-party
                travel suppliers, such as airlines and other travel providers.
                These suppliers independently operate their own services and are
                responsible for their respective schedules, policies, fares, and
                service delivery.
              </p>
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                ...
                Certain tickets may be restricted, non-refundable, or subject to
                penalties.
              </p>
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                ...
                entry, exit, immigration, health, and documentation requirements
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                ...
                do not control and are not responsible for their:
              </p>
              ...
              <p className="mt-4 text-gray-600">
                Before engaging with an external provider, you should review its
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                If you become aware of unauthorized access, suspicious activity,
                or a potential security issue involving your account, please
                notify us promptly.
              </p>
            </section>
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                The materials available through FinoTravels, including its text,
                graphics, logos, designs, layouts, images, and other website
                content, are owned by TravelFirst LLC or used with appropriate
                authorization.
              </p>
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                Because airlines and other suppliers independently operate their
                services, we cannot guarantee uninterrupted travel or a
            ...
            <section className="mb-10">
              ...
              <p className="mt-4 text-gray-600">
                Nothing in these Terms is intended to remove or limit any rights
                or protections that cannot legally be waived.
              </p>
            </section>
