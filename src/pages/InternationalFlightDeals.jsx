                    ...
                    <div className="container-main">
                        <div className="max-w-3xl py-20 md:py-24">
                            ...
                            <p className="mt-5 text-base leading-7 text-white/80 md:text-lg">
                                ...
                                studying abroad, or planning a long-awaited getaway, FinoTravels
                                helps you explore international flight options worldwide.
                            </p>
                    ...
                    <div className="mt-10 grid gap-8 lg:grid-cols-2">
                        ...
                        <div className="rounded-2xl bg-dark p-7 text-white shadow-sm">
                            ...
                            <p className="mt-5 leading-7 text-white/75">
                                Need help? Call (855) 750-2746 to discuss your destination,
                                dates, available flight options, and booking requirements with
                                our travel team.
                            </p>
